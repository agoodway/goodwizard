...
- **THEN** an error message SHALL be saved to the target Messaging room indicating the cron task failed
...
The system SHALL enforce a maximum number of concurrent isolated cron agents to prevent resource exhaustion.
