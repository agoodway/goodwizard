defmodule Goodwizard.Actions.KnowledgeBase.RefreshTools do
  @moduledoc """
  Regenerates typed knowledge base tools after schema changes.
  ...
  use Jido.Action,
    name: "refresh_knowledge_base_tools",
    description:
      "Regenerate typed knowledge base tools when schemas changed outside the agent " <>
  ...
  def run(_params, context) do
    ...
    {:ok, %{message: "Regenerated #{length(modules)} knowledge base tools", tools: tool_names}}
  end
end
